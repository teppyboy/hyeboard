...
```bash
helm upgrade --install hyeboard oci://ghcr.io/teppyboy/charts/hyeboard --version 0.2.1 --namespace hyeboard --create-namespace --values /path/to/values.yml --wait --atomic --timeout 15m
