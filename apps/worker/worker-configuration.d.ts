/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 033c1f6ddbb194b25e3c038b0aecfa11)
// Runtime types generated with workerd@1.20260820.1 2026-07-02 nodejs_compat
interface __BaseEnv_Env {
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	HYEB_ALLOWED_ORIGINS: "";
	HYEB_BROWSER_WS_ENDPOINT: "";
	HYEB_LOG_LEVEL: "debug";
	...
	VNU_CROSS_DETAIL_MAX_TARGETS: "50";
	VNU_CROSS_DETAIL_MAX_ROWS: "200";
	VNU_CROSS_DETAIL_CONCURRENCY: "6";
	VNU_CROSS_DETAIL_BUDGET: "300";
	VNU_CROSS_DETAIL_WINDOW_SECONDS: "600";
	VNU_CROSS_DETAIL_EXPORT_MODE: "selected";
	VNU_CROSS_DETAIL_PERMIT_TTL_SECONDS: "1200";
	HYEB_SESSION_SECRET: string;
	CAPTCHA_RELAY: DurableObjectNamespace<import("./src/index").CaptchaRelayDurableObject>;
	FEATURE_POLICY: DurableObjectNamespace<import("./src/index").FeaturePolicyDurableObject>;
	VNU_PROBE_BUDGET: DurableObjectNamespace<import("./src/index").VnuProbeBudgetDurableObject>;
	VNU_REFRESH_CONTROL: DurableObjectNamespace<import("./src/index").VnuRefreshControlDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CaptchaRelayDurableObject" | "VnuProbeBudgetDurableObject" | "VnuRefreshControlDurableObject" | "FeaturePolicyDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HYEB_ALLOWED_ORIGINS" | "HYEB_BROWSER_WS_ENDPOINT" | "HYEB_LOG_LEVEL" | "VNU_FAR_WALK_ENABLED" | "VNU_CODE_LOOKUP_CONCURRENCY" | "VNU_CROSS_LOOKUP_BULK_MAX_TARGETS" | "VNU_CROSS_LOOKUP_DIRECT_CHUNK_MAX_TARGETS" | "VNU_CODE_LOOKUP_BULK_TARGET_CONCURRENCY" | "VNU_CROSS_LOOKUP_REQUEST_TIMEOUT_MS" | "VNU_CROSS_DETAIL_MAX_TARGETS" | "VNU_CROSS_DETAIL_MAX_ROWS" | "VNU_CROSS_DETAIL_CONCURRENCY" | "VNU_CROSS_DETAIL_BUDGET" | "VNU_CROSS_DETAIL_WINDOW_SECONDS" | "VNU_CROSS_DETAIL_EXPORT_MODE" | "VNU_CROSS_DETAIL_PERMIT_TTL_SECONDS" | "HYEB_SESSION_SECRET">> {}
}
